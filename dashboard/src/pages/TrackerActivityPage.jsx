...
import { tracker_activity } from "../data/mockData.js";
...
export default function TrackerActivityPage() {
  ...
  const rows = useMemo(() => {
    ...
    return tracker_activity.filter(
      (t) =>
  ...
  return (
    <div className="flex-1 flex flex-col bg-background">
      <Header title="Tracker Activity" subtitle={`${tracker_activity.length} trackers blocked`} />
